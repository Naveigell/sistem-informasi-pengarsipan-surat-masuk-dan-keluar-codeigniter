...
<head>
	...
	<style>
		.login-image {
			background: url("<?= base_url(); ?>assets/img/logo/logo.png") no-repeat center center;
								...
								<form class="user" method="post" action="<?= base_url() ?>login/do_login">
									...
									<div class="form-group">
										...
										<?php if (isset($errors['password'])) {?>
											<span class="text text-danger"><?php echo $errors['password']; ?></span>
										<?php } ?>
									</div>
									<div class="form-group">
...
<!--								</div>-->
					...
					<div class="row d-flex justify-content-center">
						<div class="text-center text p-5 font-weight-bold">
